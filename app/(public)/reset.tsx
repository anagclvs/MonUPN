      ...
      {successfulCreation && (
        <>
          <View>
            ...
            <TextInput placeholder="Nouveau mot de passe" value={password} onChangeText={setPassword} secureTextEntry style={styles.inputField} />
          </View>
          <Button onPress={onReset} title="Reinitialiser" color={'#6c47ff'}></Button>
        </>
      )}
    </View>
  );
